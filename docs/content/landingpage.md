...
> **Note**: There is always an up-to-date config file at [`exampleSite/hugo.yaml`](https://github.com/anoduck/fresh-fork/blob/master/exampleSite/hugo.yaml) that contains all possible configurations.
...
hero:
  ...
  - logo: kromo
    url: https://github.com/anoduck/fresh-fork
  - logo: infinite
...
footer:
  ...
  socialmedia:
  - link: https://github.com/anoduck/fresh-fork
